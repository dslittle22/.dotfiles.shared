...
echo "- brew install neovim fzf ripgrep tree-sitter-cli prettierd gawk"
echo "- npm i -g @styled/typescript-styled-plugin typescript-styled-plugin vscode-langservers-extracted"
echo "- Open nvim and run :MasonInstall lua-language-server"
